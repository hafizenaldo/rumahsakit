...
class _PageDetailRSState extends State<PageDetailRS> {
  ...
  Future<void> fetchKamarData(String rumahSakitId) async {
    ...
    try {
      final response = await http.get(Uri.parse('http://192.168.137.1/rumahsakitDB/getKamar.php?id_rs=$rumahSakitId'));
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Padding(
                        ...
                        child: Card(
                          ...
                          elevation: 5,
                          child: ListTile(
                            leading: Icon(Icons.hotel, size: 40, color: Colors.black54),
                            title: Text(
                              kamar.namaKamar,
                              style: TextStyle(
                                color: Colors.black54,
